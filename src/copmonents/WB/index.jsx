      ...
      function compileListeners(tool) {
        ...
        function compile(listener) {
          ...
          return function listen(evt) {
            var x = (evt.pageX-document.getElementById("board").getBoundingClientRect().left-window.scrollX) / Tools.getScale(),
              y = (evt.pageY-document.getElementById("board").getBoundingClientRect().top-window.scrollY) / Tools.getScale();
